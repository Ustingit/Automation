...
//	public static final String webURL = "https://34.107.155.61";
	public static final String webURL = "https://test.curaesoft.com/";
	...
	// Roles	public static final String QA_ROLE = "qa";
